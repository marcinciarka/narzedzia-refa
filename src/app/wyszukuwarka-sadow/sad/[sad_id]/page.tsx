          ...
          .map((districtCourt) =>
            districtCourt ? (
              <Link
                ...
                href={`/wyszukuwarka-sadow/sad/${districtCourt.item.fullCourtNameEncoded}`}
              >
                <Court
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 p-4">
        {finalRegionalCourtsList.map((regionalCourt) => (
          <Link
            ...
            href={`/wyszukuwarka-sadow/sad/${selectedDistrictCourt.fullCourtNameEncoded}?regional=${regionalCourt.item.fullCourtNameEncoded}`}
          >
            <Court
